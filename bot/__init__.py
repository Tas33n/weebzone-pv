...
OWNER_ID = environ.get('OWNER_ID', '604152966')
if len(OWNER_ID) == 0:
...
if len(TGH_THUMB) == 0:
    TGH_THUMB = 'https://graph.org/file/7a3c091d0901751e5886f.jpg'
...
MIRROR_ENABLED = environ.get('MIRROR_ENABLED', 'True')
...
CLONE_ENABLED = environ.get('CLONE_ENABLED', 'True')
...
TELEGRAPH_STYLE = environ.get('TELEGRAPH_STYLE', 'True')
